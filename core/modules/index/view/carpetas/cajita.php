          ...
          <?php
            ...
            <small>
              <div class="box-tools pull-left">
                <a href="index.php?view=carpetaarea&area_oficina_id=<?php echo $_GET["id_area_oficina"]; ?>" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> <i class="fa fa-folder-open"></i> Créer Archive</a>
          ...
          <?php
            ...
            if(count($carpetas)>0){
              ...
              foreach($carpetas as $ver){
                ...
                <td style="width:80px;">
                  <a href="index.php?view=configuracioncarpetaarea&id_carpeta=<?php echo $car->id_carpeta;?>&tid=<?php echo $team->id_area_oficina;?>" class="btn btn-success btn-sm btn-flat"><i class='fa fa-cog'></i>Modifier</a>
                  <!-- <a href="#" title="Usted se encuentra en modo Encargado y no puede Supprimer" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-trash-o"></i> Supprimer</a> -->
                </td>
                </tr>
                <?php
          ...
          <?php
            ...
            if(count($carpetas)>0){
              ...
              foreach($carpetas as $ver){
                ...
                <td style="width:180px;">
                  <a href="index.php?view=configuracioncarpetaarea&id_carpeta=<?php echo $car->id_carpeta;?>&tid=<?php echo $team->id_area_oficina;?>" class="btn btn-success btn-sm btn-flat"><i class='fa fa-cog'></i>Modifier</a>
                  <a href="#" title="Vous êtes en mode Responsable et ne pouvez pas supprimer" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-trash-o"></i> Supprimer</a>
                </td>
                </tr>
                <?php
