<div class="content-wrapper">
    <section class="content-header">
      ...
      RAPPORT DE TOUS LES DOCUMENTS ACTIFS
      </h1>
    </section>
      ...
      <div class="box">
        <div class="box-header with-border">
          <div class="box-tools pull-right">
                <a href="<?php echo 'api/export/documents.php?active=1&category='.$_GET['category'].'&sd='.$_GET["sd"].'&ed='.$_GET["ed"]; ?>" target="_blank" class="btn btn-warning btn-sm btn-flat"><i class="fa fa-file-excel-o"></i> Exporter par date et catégorie</a>
                <a href="<?php echo 'api/export/documents.php?active=1&sd='.$_GET["sd"].'&ed='.$_GET["ed"]; ?>" target="_blank" class="btn btn-info btn-sm btn-flat"><i class="fa fa-file-excel-o"></i> Exporter par date</a>
    ...
    <?php if(isset($_GET["sd"]) && isset($_GET["ed"]) ):?>
      ...
      <?php 
          ...
          if(isset($_GET['category']) && $_GET['category']!="0" &&  $_GET['category']!="undefined"){
            $operations = DocumentoData::getActiveByDateAndCarpeta($_GET['category'],$_GET["sd"],$_GET["ed"],2);
          }
          elseif( !isset($_GET["id_archivo"]) || $_GET["id_archivo"]==""){
            $operations = DocumentoData::getActiveByDateOfficialll($_GET["sd"],$_GET["ed"],2);
          }
          else{
            $operations = DocumentoData::getActiveByDateOfficialBP($_GET["id_archivo"],$_GET["sd"],$_GET["ed"],2);
          } 
       ?>
