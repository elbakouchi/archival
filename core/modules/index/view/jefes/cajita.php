          ...
          <?php
              ...
              <table id="example1" class="table table-bordered table-dark" style="width:100%">
                ...
                <?php
                  ...
                  echo "<p class='alert alert-danger'>No hay Jefes del Area Registrado</p>";
                }
                ?>
                </tbody>
              </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><i class="fa fa-user"></i><b> Registro de un Nuevo Jefe del Area</b></h4>
            </div>
            <div class="modal-body has-feedback has-error">
              <form class="form-horizontal" method="POST" action="index.php?action=nuevojefe">
                ...
                <div class="form-group has-feedback has-error">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="dni" name="dni" required onkeypress="return solonumeros(event)" onpaste="return false" omaxlength="8">
                ...
                <div class="form-group has-feedback has-error">
                    <label for="inputEmail1" class="col-sm-3 control-label">Area/Oficina</label>
                    <div class="col-sm-9">
                      <?php
                          $niveles = AreaOficinaData::getAll();
                           if(count($niveles)>0):?>
                        <select name="area_oficina_id" id="area_oficina_id"  class="form-control">
                          <!-- <option value="">Seleccionar</option> -->
                          <?php foreach($niveles as $nivel):?>
                          <option value="<?php echo $nivel->id_area_oficina; ?>"><i class="fa fa-circle"></i><?php echo $nivel->nombre;  ?></option>
                          <?php endforeach; ?>
                        </select>
                        <?php endif; ?>
                    </div>
