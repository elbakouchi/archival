...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
          <form>
            <input type="hidden" name="view" value="reporteadministrador">
            <div class="row">
            <div class="col-md-3">
...
<?php if($_GET["sd"]!=""&&$_GET["ed"]!=""):?>
      ...
      if($_GET["id_usuario"]==""){
      $operations = Userdata::getAllByAdmin($_GET["sd"],$_GET["ed"],2);
      }
      else{
      $operations = Userdata::getAllByDateAdmin($_GET["id_usuario"],$_GET["sd"],$_GET["ed"],2);
      } 
       ?>
...
<?php foreach($operations as $operation):?>
  <tr>
    ...
    <td><?php if($operation->area_oficina_id!=null){echo $operation->getAreaOficina()->nombre;}else{ echo "ADMINISTRADOR DEL SISTEMA"; }  ?></td>
