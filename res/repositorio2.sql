...
--
CREATE DATABASE IF NOT EXISTS `repositorio` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `repositorio`;
...
DROP TABLE IF EXISTS `area_oficina`;
...
DROP TABLE IF EXISTS `arecarpeta`;
...
DROP TABLE IF EXISTS `carpetaarchivo`;
...
DROP TABLE IF EXISTS `periodoarea`;
...
DROP TABLE IF EXISTS `periodocarpeta`;
